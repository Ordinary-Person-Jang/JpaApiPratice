...
class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Book book = createBook("JPA Programming", 10000, 10);
    ...
    public void 주문취소() throws Exception {
        //give
        Member member = createMember();
        Book item = createBook("JPA Program", 10000, 10);
        ...
        assertEquals(10, item.getStockQuantity(), "주문이 취소된 상품은 그만큼 제고가 증가해야한다.");
    }
    ...
    private Member createMember() {
        ...
        member.setAddress(new Address("Seoul", "HanGang-ro", "4885"));
        em.persist(member);
        return member;
    }
}